// given a set of words =>{"SNAKE", "FOR", "QUEZ", "SNACK", "SNACKS", "GO","TUNES","CAT"};
    
//         and a board ==> { { 'S', 'E', 'R' ,'T'}, 
//                           { 'U', 'N', 'K' ,'S'},
//                           { 'T', 'C', 'A' ,'T'} };
// we need to find if we can find the words in the board considering you can traverse from
// one character to all its neighbouring characters i.e in all eight directions .

// not you should not  form a cycle 
// the question is solved using  the trie data structure.
